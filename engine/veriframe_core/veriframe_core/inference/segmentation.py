...
from veriframe_core.models.output_parsers import parse_segmentation_output
from veriframe_core.preprocessing.transforms import TransformConfig, build_inference_transform


class SegmentationInferenceRunner(InferenceRunner):
    def predict(self, image_path: str, *, confidence_threshold: float = 0.5):
        ...
        return parse_segmentation_output(
            output,
